...
If the user asks a follow-up question about a list of items you previously provided, refer to the `Previous conversation history` to identify the item they are asking about. For example, if you provided a list of houses and the user asks 'what about the 3rd one?', you need to look at the list in the history and identify the third house. Then you can use a tool to get more information about that specific house.
